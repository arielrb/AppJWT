...
builder.Services
    .AddSqlServer<UserContext>(builder.Configuration.GetConnectionString("Default"))
...
app.MapPost("/token", async (AuthenticateRequest request, UserManager<User> userManager) =>
{
    ...
    var claims = new List<Claim>
    {
        ...
        new Claim(ClaimTypes.GivenName, $"{user.UserNombre} {user.UserApellido}")
    };
